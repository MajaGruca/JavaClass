...
public class ClockWithGui extends JPanel {
    ...
    public void paintComponent(Graphics g){
        ...
        AffineTransform save2AT = g2d.getTransform();
        g2d.rotate(time.getMinute()%60*2*Math.PI/60);
        g2d.drawLine(0,0,0,-90);
        g2d.setTransform(save2AT);

        AffineTransform save3AT = g2d.getTransform();
        g2d.rotate(time.getSecond()%60*2*Math.PI/60);
        g2d.drawLine(0,0,0,-100);
        g2d.setTransform(save3AT);

        for(int i=1;i<61;i++){
            AffineTransform save4AT = g2d.getTransform();
            g2d.rotate(i*2*Math.PI/60);
            g2d.drawLine(0,-95,0,-100);
            g2d.setTransform(save4AT);
        }
